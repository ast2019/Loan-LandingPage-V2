    ...
    <section className="py-24 px-6 bg-white">
      <div className="max-w-[1156px] mx-auto">
        ...
        <div className="relative">
          {/* Progress Line - Updated to 20% to reach step 2 */}
          <div className="hidden lg:block absolute top-[28px] left-[10%] right-[10%] h-1 bg-slate-100 -translate-y-1/2 rounded-full overflow-hidden">
             <div className="w-[20%] h-full bg-[#ea4037] transition-all duration-1000"></div>
          </div>
            ...
            {steps.map((item) => {
              ...
              return (
                <div key={item.step} className="flex flex-col items-center text-center group">
                  ...
                  <h3 className={`text-base font-black mb-3 whitespace-nowrap transition-colors ${isActive ? "text-slate-900" : "text-slate-400"}`}>
                    {item.title}
                  </h3>
