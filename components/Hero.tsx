        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
          ...
          <div className="flex-1 text-center lg:text-right reveal active">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 lg:gap-5 justify-center lg:justify-start">
              <button className="w-full sm:w-auto px-10 lg:px-12 py-4 lg:py-5 bg-[#ea4037] text-white rounded-[1.5rem] lg:rounded-[2rem] font-black text-lg lg:text-xl shadow-2xl shadow-red-200 hover:bg-[#d1352d] transition-all transform hover:scale-[1.03] shine-soft">
                شروع درخواست
              </button>
